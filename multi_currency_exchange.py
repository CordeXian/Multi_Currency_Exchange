...
for target_curr in display_list:
    ...
    # 第一行：按鈕 + 幣別資訊
    c_pin, c_swap, c_info = st.columns([1.2, 1.2, 7.6], vertical_alignment="center")
    ...
    with c_info:
        ...
        <div style="display:flex; align-items:center; min-width:0;">
            ...
            <div class="currency-name-block" style="min-width:0;">
