...
<style>
  ...
  * { min-width: 0 !important; }
  ...
  /* 🔥 Source selectbox：關閉省略號，必要時允許換行顯示（不再 TWD...） */
  ...
  /* ✅ 列與列之間空隙縮很緊：用專用 hr 控制 */
  .fx-hr{
      margin: 0.18rem 0 !important;   /* 超小 */
...
for target_curr in display_list:
    ...
    # ✅ 用專用 hr 壓縮列間距（你要的「不要 USD 空一大段到 VND」）
