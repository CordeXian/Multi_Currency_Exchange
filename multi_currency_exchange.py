...
<style>
  ...
  * { min-width: 0 !important; }
  ...
  div[data-testid="stVerticalBlock"] { gap: 0.10rem !important; } /* 讓垂直 block 間距縮小 */
  .element-container { margin-bottom: 0.10rem !important; }       /* 每個元素容器的下方空白縮小 */
  ...
  /* ✅ 列與列之間空隙：縮小到約 1/3 */
  .fx-hr{
      margin: 0.06rem 0 !important;   /* 原本 0.18 -> 0.06，大約 1/3 */
  ...
  @media (max-width: 420px){
      ...
      /* 手機上 Source 比例稍微保守一點：68/32，避免太擠 */
      .source-row div[data-testid="stHorizontalBlock"] [data-testid="column"]:nth-child(1){
