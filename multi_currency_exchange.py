...
# --- ✨ CSS：UI + 參考 Mobile版做法（不改架構，修正錯位/爆版 + 微調字體/欄寬） ---
st.markdown("""
<style>
  /* 版面限制 */
  .block-container{
  ...
  * { min-width: 0 !important; }
  ...
  /* 結果文字區：不換行 + 超出省略，避免擠爆 */
  .result-text {
      font-size: calc(1.2rem + 1px) !important;   /* ✅ 金額字體 +1px */
      font-weight: bold;
      text-align: right;
      color: #4CAF50;
      line-height: 1.1;
  ...
  .currency-code {
      font-weight: bold;
      font-size: calc(1.05rem + 1px) !important;  /* ✅ 幣別字體 +1px */
      color: #FFF;
      white-space: nowrap;
      overflow: hidden;
      text-overflow: ellipsis;
  ...
  .currency-zh {
      font-size: calc(0.85rem + 1px) !important;  /* ✅ 中文字體 +1px */
  ...
  /* ============================
     ✅ Source 區塊：左邊幣別加寬，右邊金額可窄一點（避免 TW…）
     ============================ */
  ...
  .source-row div[data-testid="stHorizontalBlock"] [data-testid="column"]:nth-child(1){
      flex: 0 0 55% !important;
      width: 55% !important;
      min-width: 55% !important;
  }
  .source-row div[data-testid="stHorizontalBlock"] [data-testid="column"]:nth-child(2){
  ...
  @media (max-width: 420px){
      ...
      /* 手機字體微縮（仍然比原本大 1px） */
      .currency-code { font-size: calc(0.98rem + 1px) !important; }
      .currency-zh { font-size: calc(0.78rem + 1px) !important; }
      .result-text { font-size: calc(1.05rem + 1px) !important; }
