...
<style>
  ...
  /* 關鍵修正：防止 Streamlit 欄位在手機上自動堆疊/爆版 */
  ...
  @media (max-width: 420px){
      ...
      div.row-widget.stButton > button { height: 2.15rem !important; }

      .flag-img { width: 28px; height: 21px; margin-right: 6px; }
...
for target_curr in display_list:
    ...
    # ✅ 關鍵：縮小左邊按鈕占比，避免手機爆版
    # 原本 [1.3, 1.3, 3.2, 4.2] 在部分手機會擠爆
    c_pin, c_swap, c_info, c_res = st.columns([1.0, 1.0, 3.0, 4.0], vertical_alignment="center")
